...
// import { View, Text, List, Button, Image, TextField} from "react-native";
...
//     return (
//         <View style={tw`text-bold px-2 h-full`} style={{
//             fontSize: "1rem",
//             fontWeight: "bold",
...
//         }}>
//             <View style={tw`flex items-center mx-2 pt-4 text-center  w-11/12 cursor-pointer`}>
//                 <Image style={{ height: "50px", maxWidth: "unset", borderRadius: "999px" }} src={stakePool.tokenImageURL} />
//                 <Text style={tw`ml-2 px-1 text-lg leading-none`}>
//                     {stakePool.poolName}
//                     <Text style={tw`text-green-500 text-sm`}>
//                         {Math.round(stakePool.tokenMintSupply) || 0} {stakePool.tokenSymbol}
//                     </Text>
//                 </Text>
//                 <Text style={tw`mx-auto px-1 text-lg leading-none`}>
//                     Balance
//                     <Text style={tw`text-green-500 text-sm`}>
...
//                 <View style={tw`cursor-pointer mx-2`} onPress={() => { window.xnft.openWindow(stakePool.website) }}>
...
//                 <View style={{ border: "solid", borderColor: THEME.colors?.bg2, backgroundColor: tabIndex == 0 ? THEME.colors?.bg2 : "", opacity: tabIndex == 0 ? 1 : .5 }} tw={`py-3 w-1/2 cursor-pointer rounded-l transition ease-linear`} onPress={() => setTabIndex(0)}>Stake</View>
//                 <View style={{ border: "solid", borderColor: THEME.colors?.bg2, backgroundColor: tabIndex == 1 ? THEME.colors?.bg2 : "", opacity: tabIndex == 1 ? 1 : .5 }} tw={`py-3 w-1/2 cursor-pointer rounded-r transition ease-linear`} onPress={() => setTabIndex(1)}>Unstake</View>
//             </View>
...
//                             <View tw={`mr-auto`}>Balance: {(solBalance / LAMPORTS_PER_SOL).toFixed(3)} SOL</View><Button onPress={() => setStakeAmount(solBalance > 0 ? solBalance / LAMPORTS_PER_SOL - .05 : 0)} tw={`text-sm cursor-pointer`}>Max</Button>
//                         </View>
//                         <View tw={"mt-4"}>
...
//                         </View>
//                         <Button disabled={true} onPress={handleDepositSwapPath} style={{ opacity: selectedSwapStake == null ? 0.5 : 1 }} style={tw`mt-auto w-full mb-1`}>Stake SOL</Button>
...
//                         <View tw={`flex items-baseline mt-2`}>
//                             <View tw={`mr-auto`}>Balance: {tokenBalance.toFixed(3)} {stakePool.tokenSymbol}</View><Button onPress={() => setUnStakeAmount(tokenBalance)} tw={`text-sm cursor-pointer`}>Max</Button>
//                         </View>
//                         <View tw={"mt-4"}>
...
//                         </View>
//                         <Button disabled={true} style={{ opacity: selectedSwapUnstake == null ? 0.5 : 1 }} onPress={handleUnstakeSwapPath} style={tw`w-full mt-auto mb-1`}>Unstake</Button>
//                     </View>
//                 }
//             </View>
//         </View >
...
//     return (
//         <View tw={`relative p-3 mb-2 cursor-pointer rounded transition ease-linear`} style={{ border: "solid", borderColor: THEME.colors?.secondary, backgroundColor: THEME.colors?.bg2, opacity: active ? 1 : 0.5, borderWidth: active ? "2px" : "0px" }} onPress={() => setSelectedSwap("DIRECT")}>
//             <View style={tw`absolute top-0 right-2 text-xs`}>Stake Pool</View>
//             <View>
...
//     if (isLoading) {
//         return (
//             <View tw={`animate-pulse relative p-3 cursor-pointer rounded`} style={{ height: 72, border: "solid", borderColor: THEME.colors?.secondary, backgroundColor: THEME.colors?.bg2, opacity: active ? 1 : 0.5, borderWidth: active ? "2px" : "0px" }} onPress={() => setSelectedSwap("JUPITER")}>
//                 <View style={tw`animate-pulse absolute top-0 right-2 text-xs`}>Jupiter Swap</View>
//             </View>
//         )
//     }
...
//     return (
//         <View tw={`relative p-3 cursor-pointer rounded transition ease-linear`} style={{ border: "solid", borderColor: THEME.colors?.secondary, backgroundColor: THEME.colors?.bg2, opacity: active ? 1 : 0.5, borderWidth: active ? "2px" : "0px" }} onPress={() => setSelectedSwap("JUPITER")}>
//             <View style={tw`absolute top-0 right-2 text-xs`}>Jupiter Swap</View>
//             <View>
//                 {outAmount}
//                 <View tw={`font-light text-sm`}>
//                     {routeText || ""}
